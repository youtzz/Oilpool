package org.shichuangnet.jojo.dashboardview;
...
public class DashboardView extends View {
    ...
    private double mRealTimeValue = mMin; // 实时读数
    ...
    public DashboardView(Context context, AttributeSet attrs) {
        ...
        mMin = typedArray.getInteger(R.styleable.DashboardView_min, 0);
        mMax = typedArray.getInteger(R.styleable.DashboardView_max, 100);
        mSection = typedArray.getInteger(R.styleable.DashboardView_section, 10);
        mPortion = typedArray.getInteger(R.styleable.DashboardView_portion, 10);
        mHeaderText = typedArray.getString(R.styleable.DashboardView_headerText);
        isShowValue = typedArray.getBoolean(R.styleable.DashboardView_isShowValue, true);
        init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mRectFArc.set(
                ...
                getMeasuredHeight() - getPaddingBottom() - mStrokeWidth
        );
    ...
    protected void onDraw(Canvas canvas) {
         ...
         * 画指针
         */
        float θ = mStartAngle + mSweepAngle * ((float)mRealTimeValue - mMin) / (mMax - mMin); // 指针与水平线夹角
